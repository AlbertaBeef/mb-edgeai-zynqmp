...
# ---------------------------------------------------------------------------------------
# NOTE: The ZCU106 HPC1 cannot support two M2 slots, because it only has one MGT routed to
...
# M2 slot 2 ref clock is left unconnected on the ZCU106 HPC1 connector

# MGT locations
# M2 slot 1 HPC1_DP0 (PCIe lane 0) is connected to MGT bank 223 (X0Y0-X0Y3), specifically X0Y3
...
# ZCU106 HPC1 transceivers for M2 slot 1 are best aligned with PCIE_X0Y0
