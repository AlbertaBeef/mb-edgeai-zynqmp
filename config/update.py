...
def create_tables(data):
    ...
    for group in used_groups:
        ...
        tables.append('')
        tables.append('| Target board          | Target design   | FMC Slot(s) | Cameras | Active M.2 Slots | VCU   | Stack Design | Vivado<br> Edition | IP<br>License |')
        tables.append('|-----------------------|-----------------|-------------|---------|------------------|-------|--------------|-------|-------|')
        for design in data['designs']:
            if not design['publish']:
                continue
...
args_path = '../Vitis/py/args.json'
args = load_json(args_path) if os.path.isfile(args_path) else {}
file_path = '../README.md'
